...
const Projects = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-12">
            <SEO title="Projects" description="Explore my projects in full-stack development, AI, and more." />
            <h1 className="text-4xl font-bold mb-12 text-center bg-gradient-to-r from-primary-400 to-primary-600 bg-clip-text text-transparent">Projects</h1>
